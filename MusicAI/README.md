...
# This project is an interactive Spotify analytics web app built with Python, Streamlit, and the Spotify Web API.

# It allows users to analyze their personal playlists and compare them against:

# ✅ My curated playlist

# ✅ Global Spotify 2025 charts

# 

# The app focuses on data-driven music insights, combining API data acquisition, statistical analysis, and interactive visualizations.
